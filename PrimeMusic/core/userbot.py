...
class Userbot(Client):
    ...
    async def start(self):
        ...
        if config.STRING1:
            ...
            try:
                await self.one.join_chat("teamosmani")
                await self.one.join_chat("osmanigroupbot")
            except:
                pass
            assistants.append(1)
            try:
        ...
        if config.STRING2:
            ...
            try:
                await self.two.join_chat("teamosmani")
                await self.two.join_chat("osmanigroupbot")
            except:
                pass
            assistants.append(2)
            try:
        ...
        if config.STRING3:
            ...
            try:
                await self.three.join_chat("teamosmani")
                await self.three.join_chat("osmanigroupbot")
            except:
                pass
            assistants.append(3)
            try:
        ...
        if config.STRING4:
            ...
            try:
                await self.four.join_chat("teamosmani")
                await self.four.join_chat("osmanigroupbot")
            except:
                pass
            assistants.append(4)
            try:
        ...
        if config.STRING5:
            ...
            try:
                await self.five.join_chat("teamosmani")
                await self.five.join_chat("osmanigroupbot")
            except:
                pass
            assistants.append(5)
            try:
        ...
        if config.STRING6:
            ...
            try:
                await self.six.join_chat("teamosmani")
                await self.six.join_chat("osmanigroupbot")
            except:
                pass
            assistants.append(6)
            try:
        ...
        if config.STRING7:
            ...
            try:
                await self.seven.join_chat("teamosmani")
                await self.seven.join_chat("osmanigroupbot")
            except:
                pass
            assistants.append(7)
            try:
        ...
        if config.STRING8:
            ...
            try:
                await self.eight.join_chat("teamosmani")
                await self.eight.join_chat("osmanigroupbot")
            except:
                pass
            assistants.append(8)
            try:
        ...
        if config.STRING9:
            ...
            try:
                await self.nine.join_chat("teamosmani")
                await self.nine.join_chat("osmanigroupbot")
            except:
                pass
            assistants.append(9)
            try:
        ...
        if config.STRING10:
            ...
            try:
                await self.ten.join_chat("teamosmani")
                await self.ten.join_chat("osmanigroupbot")
            except:
                pass
            assistants.append(9)
            try:
            ...
            LOGGER(__name__).info(
                f"Assistant Osmani Started as {self.ten.name}"
            )
